...
{
    public class LatestBollywoodGossipSection : Section<YouTubeSchema>
    {
		private YouTubeDataProvider _dataProvider;
		
		public LatestBollywoodGossipSection()
		{
			_dataProvider = new YouTubeDataProvider(new YouTubeOAuthTokens
			{
				ApiKey = "AIzaSyD6RNLn-rg9Im6TkHMplER4lk7aBKd1nYw"
			});
		}
        ...
        public override ListPageConfig<YouTubeSchema> ListPage
        {
            get 
            {
                return new ListPageConfig<YouTubeSchema>
                {
                    ...
                    {
						return NavInfo.FromPage<Pages.LatestBollywoodGossipDetailPage>(true);
                    }
                };
            }
        }
