...
{
    public class ReviewsByKiranSection : Section<RssSchema>
    {
		private RssDataProvider _dataProvider;

		public ReviewsByKiranSection()
		{
		...
		public override async Task<IEnumerable<RssSchema>> GetDataAsync(SchemaBase connectedItem = null)
        {
            ...
            {
                Url = new Uri("http://reviewsbykiran.blogspot.com/feeds/posts/default?alt=rss"),
            };
        ...
        public override ListPageConfig<RssSchema> ListPage
        {
            get 
            {
                return new ListPageConfig<RssSchema>
                {
                    ...
                    Page = typeof(Pages.ReviewsByKiranListPage),
                    ...
                    {
						return NavInfo.FromPage<Pages.ReviewsByKiranDetailPage>(true);
                    }
                };
            }
        }
