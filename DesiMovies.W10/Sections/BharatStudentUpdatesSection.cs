...
{
    public class BharatStudentUpdatesSection : Section<RssSchema>
    {
		private RssDataProvider _dataProvider;

		public BharatStudentUpdatesSection()
		{
        ...
        public override ListPageConfig<RssSchema> ListPage
        {
            get 
            {
                return new ListPageConfig<RssSchema>
                {
                    ...
                    {
						return NavInfo.FromPage<Pages.BharatStudentUpdatesDetailPage>(true);
                    }
                };
            }
        }
