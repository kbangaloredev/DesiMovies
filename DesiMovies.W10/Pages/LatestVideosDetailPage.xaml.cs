//---------------------------------------------------------------------------
//
// <copyright file="LatestVideosDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class LatestVideosDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public LatestVideosDetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new LatestVideosSection());
