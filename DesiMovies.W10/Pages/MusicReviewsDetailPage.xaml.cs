//---------------------------------------------------------------------------
//
// <copyright file="MusicReviewsDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class MusicReviewsDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public MusicReviewsDetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new MusicReviewsSection());
